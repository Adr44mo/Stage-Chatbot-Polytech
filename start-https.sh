...
echo "🔁 Configuring Nginx with HTTPS config..."
# Tester la config HTTPS
sudo nginx -t -c /srv/partage/Stage-Chatbot-Polytech/Fastapi/nginx/nginx-https.conf

# Stopper nginx pour éviter les conflits
sudo systemctl stop nginx

# Lancer nginx avec notre config HTTPS
sudo nginx -c /srv/partage/Stage-Chatbot-Polytech/Fastapi/nginx/nginx-https.conf
