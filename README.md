...
- **Accès instantané** aux informations sur les cours et spécialités
- **Réponses contextuelles** basées sur les documents officiels
- **Interface intuitive** pour les étudiants et l'administration
- **Système évolutif** avec analyse d'intention et apprentissage continu
...
- **Issues GitHub** : [Créer une issue](https://github.com/username/Stage-Chatbot-Polytech/issues)
- **Documentation** : [Wiki du projet](https://github.com/username/Stage-Chatbot-Polytech/wiki)
